//
//  MosaicCollectionViewProtocol.swift
//  TestProject
//
...
@objc public protocol CollectionViewDelegateMosaicLayout: UICollectionViewDelegate {
...
public extension CollectionViewMosaicLayout.ItemRenderDirection {
...
extension CollectionViewMosaicLayout {
...
public class CollectionViewMosaicLayout: UICollectionViewLayout {
    ...
    public var delegate: CollectionViewDelegateMosaicLayout? {
        get {
            return collectionView!.delegate as? CollectionViewDelegateMosaicLayout
        }
    }
